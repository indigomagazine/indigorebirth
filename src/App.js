      ...
      <section className="skills section" id="skills">
        ...
        <div className="skills__container">  
          <div>
            ...
            <img src={human_img_one} alt="" className="life_img"/>
            <p className="about__text">
            ...
            <img src={human_img_two} alt="" className="life_img"/>
            <p className="about__text">
            ...
            <img src={human_img_three} alt="" className="life_img"/>
            <img src={human_img_four} alt="" className="life_img"/>
